// JavaScipt
/*
 * Inhalt einer JSON-Datei �ber JSONP
...
function datenHandler() {
    console.log("here");
    //var url = "http://gumball.wickedlysmart.com?callback=aktualisiereZahlen" + "&random=" + (new Date()).getTime();
...
function aktualisiereZahlen(verkauft) {
    ...
    if (verkauft.length > 0 ) {
        letzteBerichtsZeit = verkauft[verkauft.length-1].time;
    }
